...
class AnimeESRGANUpscaler: ImageUpscaler {
    ...
    private static let modelDisplayName = L10n.string("mode.anime.name")
    private static let modelFileIdentifier = "realesrganAnime512.mlmodel"
    ...
    enum UpscalerError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .modelNotFound:
                return L10n.formatted("ml.error.model_not_found", AnimeESRGANUpscaler.modelDisplayName, AnimeESRGANUpscaler.modelFileIdentifier)
            case .conversionFailed:
